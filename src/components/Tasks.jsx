          ...
          {[...tasks]
            ...
            .map((task) => (
              <tr key={task.originalIndex}>
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      updatedTasks[task.originalIndex].reminder = e.target.checked
                      setTasks(updatedTasks)
                      localStorage.setItem('tasks', JSON.stringify(updatedTasks))
                    }}
                  />
                ...
                <td>{task.activity}</td>
                <td>
                  <button onClick={() => editTask(task.originalIndex)}>{t('update')}</button>
                  <button onClick={() => deleteTask(task.originalIndex)}>{t('done')}</button>
                </td>
              </tr>
            ))}
          <tr>
