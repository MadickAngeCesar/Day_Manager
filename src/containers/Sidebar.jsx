...
function Sidebar() {
  ...
  return (
    <div className="sidebar">
      ...
      <NavLink to="/routine" activeclassname="active">{t('routine')} </NavLink>
      <NavLink to="/freeday" activeclassname="active">{t('freeday')} </NavLink>
      ...
      <NavLink to="/" activeclassname="active">{t('settings')}</NavLink>
